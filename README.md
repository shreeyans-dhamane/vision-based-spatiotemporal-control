...
Testing was done on three datasets including pool surveillance footage and industrial valve sessions. The entire pipeline runs at around 25-30 FPS on Google Colab's GPU. Main dependencies are TensorFlow and OpenCV.
